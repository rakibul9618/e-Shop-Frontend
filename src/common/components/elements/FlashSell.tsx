                ...
                <div className="flex flex-col items-center items-lg-start flash_content">
                    ...
                    <div className="flex gap-10 mt-4 countdown">
                        {countDown.map(({ id, title, time }) => (
                            <div className="flex-middle rounded text-center countdown_section" key={id}>
                                <div>
                    ...
                    <Link href="/" className="primary-btn mt-6 inline_block check_out">Check it Out!</Link>
                </div>
                <div className="poster_countdown_thumbnail">
                    <Image src="/images/flash_sell.png" alt="Poster Product" className="" width={661} height={502} />
                </div>
            </div>
        </Container>
    )
